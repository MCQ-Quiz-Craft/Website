    ...
    <section class="transition-all duration-300">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        <div class="lg:col-span-6 space-y-3.5">
          ...
          {/* Sample & Saved Test Series Cards (Now on Left Column) */}
          <div class="pt-0.5">
            <SampleTests />
          </div>
        </div>
        ...
        <div class="lg:col-span-6">
          <div class="glass-panel rounded-2xl border border-slate-200 dark:border-neutral-800 shadow-xl overflow-hidden">
